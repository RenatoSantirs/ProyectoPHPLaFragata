           ...
           echo '<tr>
                  ...
                  <td>
                    ...
                    <div class="btn-group">
                      ...
                      <button class="btn btn-info btnImprimirOrden" codigoOrden="'.$value["codigo"].'">
                      ...
                      echo '<button class="btn btn-warning btnEditarOrden" idOrden="'.$value["id"].'"><i class="fa fa-pencil"></i></button>

                      <button class="btn btn-danger btnEliminarOrden" idOrden="'.$value["id"].'"><i class="fa fa-times"></i></button>';
                    }
