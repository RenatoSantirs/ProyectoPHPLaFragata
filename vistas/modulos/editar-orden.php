              ...
              <div class="box">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                   ...
                   <input type="text" class="form-control" id="nuevaOrden" name="editarOrden" value="<?php echo $orden["codigo"]; ?>" readonly>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <?php
                      ...
                      $categorias = ControladorEmpleados::ctrMostrarEmpleados($item, $valor);
                ...
                $listaProducto = json_decode($orden["productos"], true);
                        ...
                        <tr>
                           ...
                           <td style="width: 50%">
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control input-lg" id="nuevoTotalOrden" name="nuevoTotalOrden" total="<?php echo $orden["total"]; ?>" value="<?php echo $orden["total"]; ?>" readonly required>

                              <input type="hidden" name="totalOrden" value="<?php echo $orden["total"]; ?>" id="totalOrden">
