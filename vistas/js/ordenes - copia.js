/*=============================================
CARGAR LA TABLA DINÁMICA DE ORDENES
=============================================*/

// $.ajax({

// 	url: "ajax/datatable-ordenes.ajax.php",
...
/*=============================================
AGREGANDO PRODUCTOS A LA ORDEN DESDE LA TABLA
=============================================*/

$(".tablaOrdenes tbody").on("click", "button.agregarProducto", function(){
...
/*=============================================
QUITAR PRODUCTOS DE LA ORDEN Y RECUPERAR BOTÓN
=============================================*/
...
$(".formularioOrden").on("change", "select.nuevaDescripcionProducto", function(){
...
CAMBIO EN EFECTIVO
=============================================*/
$(".formularioOrden").on("change", "input#nuevoValorEfectivo", function(){

	var efectivo = $(this).val();

	var cambio =  Number(efectivo) - Number($('#nuevoTotalOrden').val());
...
CAMBIO TRANSACCIÓN
=============================================*/
$(".formularioOrden").on("change", "input#nuevoCodigoTransaccion", function(){
...
function quitarAgregarProducto(){
	...
	//Capturamos todos los id de productos que fueron elegidos en la orden
	var idProductos = $(".quitarProducto");

	//Capturamos todos los botones de agregar que aparecen en la tabla
	var botonesTabla = $(".tablaOrdenes tbody button.agregarProducto");

	//Recorremos en un ciclo para obtener los diferentes idProductos que fueron agregados a la orden
	for(var i = 0; i < idProductos.length; i++){

		//Capturamos los Id de los productos agregados a la orden
