...
$(".tablas").on("click", ".btnImprimirOrden", function(){
	...
	window.open("extensiones/tcpdf/examples/orden.php?codigo="+codigoOrden, "_blank");
})
...
=============================================*/
 ...
 $('#daterange-btn').daterangepicker(
   ...
   function (start, end) {
	...
	window.location = "index.php?ruta=ordenes&fechaInicial="+fechaInicial+"&fechaFinal="+fechaFinal;
