...
class ModeloProductos{
	...
	static public function mdlMostrarProductos($tabla, $item, $valor, $ordenar){
	...
	static public function mdlMostrarSumaOrdenes($tabla){

		$stmt = Conexion::conectar()->prepare("SELECT SUM(ordenes) as total FROM $tabla");
